...
(function () {
  ...
  Runner.prototype = {
    ...
    */
    init: function () {
      ...
      this.horizon = new Horizon(this.canvas, this.images, this.dimensions, this.config.GAP_COEFFICIENT); // Distance meter

      this.distanceMeter = new DistanceMeter(this.canvas, this.images.TEXT_SPRITE, this.dimensions.WIDTH); // Draw t-rex
  ...
  GameOverPanel.prototype = {
    ...
    */
    draw: function () {
      ...
      this.canvasCtx.drawImage(this.textSprite, textSourceX, textSourceY, textSourceWidth, textSourceHeight, textTargetX, textTargetY, textTargetWidth, textTargetHeight); // Restart button.
  ...
  */
  ...
  function checkForCollision(obstacle, tRex, opt_canvasCtx) {
    ...
    if (boxCompare(tRexBox, obstacleBox)) {
      ...
      var tRexCollisionBoxes = Trex.collisionBoxes; // Detailed axis aligned box check.
  ...
  */
  ...
  function Horizon(canvas, images, dimensions, gapCoefficient) {
    ...
    this.cloudFrequency = this.config.CLOUD_FREQUENCY; // Cloud
    ...
    this.horizonLine = null; // Obstacles
...
//# sourceMappingURL=/dino.6d942b18.js.map